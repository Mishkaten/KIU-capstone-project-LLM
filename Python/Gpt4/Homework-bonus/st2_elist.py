...
class UIDGenerator:
    id_seed = 1000  # Starting seed, a four-digit integer
    ...
    @classmethod
    def generate_id(cls):
        num_part = cls.generateRandomNumberString(3)
        hex_part = cls.decimalToHexavigesimal(cls.id_seed)
        cls.id_seed += 1
        return f"{num_part}-{hex_part}"
