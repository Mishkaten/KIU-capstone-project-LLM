...
def knapsack(items: list, max_weight: int) -> int:
    ...
    # Dynamic programming table where dp[i][w] represents the maximum value that can be obtained with the first i items and weight limit w
    ...
    # The optimal value will be in dp[n][max_weight]
