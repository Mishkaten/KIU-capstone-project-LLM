...
def list_operations(list1: list, list2: list) -> list:
    ...
    # Step 3: Remove duplicate elements by converting to a set and back to a list
    unique_list = list(set(sorted_list))

    # Step 4: Sort the list again to maintain order after removing duplicates
    unique_sorted_list = sorted(unique_list)
