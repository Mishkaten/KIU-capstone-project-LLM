public class RescueThePenguins {
    public static void main(String[] args) {
        ...
        if (steps < 1) {
            MiniJava.printLine("Number of steps >= 1 required");
            return;
        }
        ...
        if (young < 0 || youngAdults < 0 || adults < 0 || oldAdults < 0 || elders < 0) {
            MiniJava.printLine("Negative input not accepted");
            return;
        }
        ...
        MiniJava.printLine("Final number of young: " + young);
        MiniJava.printLine("Final number of young adults: " + youngAdults);
        MiniJava.printLine("Final number of adults: " + adults);
        MiniJava.printLine("Final number of old adults: " + oldAdults);
        MiniJava.printLine("Final number of elders: " + elders);
    }
}
