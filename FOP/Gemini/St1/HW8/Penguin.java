...
public class Penguin {
    ...
    public boolean equals(Object other) {
        ...
        if (other == null || getClass() != other.getClass()) return false; // Null or different class
        Penguin penguin = (Penguin) other;
        return birthYear == penguin.birthYear &&
                Objects.equals(name, penguin.name) &&
                gender == penguin.gender; // Compare final attributes
    }

    @Override
    public int hashCode() {
        // Combine hash codes of final attributes
