...
public class Main {
    public static void main(String[] args) {
        ...
        St1.FinalExam.Ex2.Sparse2DArray<String> sparse2DArray = new St1.FinalExam.Ex2.Sparse2DArray<>(3, 3);
        ...
        St1.FinalExam.Ex2.Sparse2DArray<String> fromArraySparse2DArray = St1.FinalExam.Ex2.Sparse2DArray.fromArray(array2d);
