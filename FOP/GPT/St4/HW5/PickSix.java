...
public class PickSix {
    ...
    public static int playerSelectCard(int player, int[][] playerCards) {
        while (true) {
            MiniJava.write("Player " + player + ", you have the following cards: ");
            ...
            MiniJava.write("Invalid card selection. Try again.");
        }
    }
    ...
    public static void outputResult(int[] playerPoints) {
        if (playerPoints[0] < playerPoints[1]) {
            MiniJava.write("Player 1 wins with " + playerPoints[0] + " points against player 2 with " + playerPoints[1] + " points.");
        } else if (playerPoints[1] < playerPoints[0]) {
            MiniJava.write("Player 2 wins with " + playerPoints[1] + " points against player 1 with " + playerPoints[0] + " points.");
        } else {
            MiniJava.write("Draw! Both players have " + playerPoints[0] + " points.");
        }
    }
