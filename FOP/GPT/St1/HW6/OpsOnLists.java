...
//        java.util.PriorityQueue<fop.lists.IntDoubleListElement> pq = new java.util.PriorityQueue<>(lists.length, (a, b) -> a.value - b.value);
//
...
//
//        while (!pq.isEmpty()) {
//            fop.lists.IntDoubleListElement minElement = pq.poll();
